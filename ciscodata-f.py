...
class model_93180:
    ...
    def get_data(self):
        ...
        result = self.es.search(index="cisco_switch_data",doc_type = "switch_counts", scroll="2m", body= {"size" : 10000,"query" :{"match_all": {}}})
        ...
        while scroll_size > 0:
              #"Scrolling..."
            result = self.es.scroll(scroll_id=sid, scroll='2m')
            data = result['hits']['hits']
            sid= result['_scroll_id']
